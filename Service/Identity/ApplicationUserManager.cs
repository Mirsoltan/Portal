...
namespace Services.Identity
{
    public class ApplicationUserManager : UserManager<User>, IApplicationUserManager
    {
        ...
        public ApplicationUserManager(
            ...
            : base(userStore, options, passwordHasher, userValidators, passwordValidators, 
        ...
        public async Task<List<UsersViewModel>> GetPaginateUsersAsync(int offset, int limit, string orderBy, string searchText)
        {
            ...
            var users = await Users.Include(u => u.Roles)
                  ...
                  || (t.RegisterDateTime >= getDateTimesForSearch.First() && t.RegisterDateTime <= getDateTimesForSearch.Last())
        ...
        /// <summary>
        /// نمیدونم کجا تعریف شده باید اصلاحش کنم
        /// </summary>
        /// <param name="UserId"></param>
        /// <returns></returns>
        public Task<UsersViewModel> FindUserWithRolesByIdAsync(string UserId)
        {
